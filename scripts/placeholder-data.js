const placeholderJobs = [
  {
    title: "Office Boy At William's House",
    type: "Internship",
    companyName: "William's House",
    locationType: "On-site",
    location: "West Jakarta, DKI Jakarta, Indonesia",
    applicationEmail: "apply@williamshouse.com",
    applicationUrl: "https://williamshouse.com/apply",
    slug: "office-boy-at-williams-house-1",
    salary: 150000,
    approved: true,
    description: `
            **About William's House**
            
            William's House is a leading real estate company specializing in residential properties. Our team is dedicated to providing exceptional service and finding the perfect home for our clients. We are currently seeking a motivated and reliable Office Boy to join our team.
            
            **Job Description**
            
            As an Office Boy at William's House, you will be responsible for maintaining cleanliness and organization in the office, running errands, and providing support to the administrative staff as needed.
            
            **Key Responsibilities**
            
            - Keep the office clean and organized.
            - Run errands such as delivering documents and packages.
            ...
            **Benefits**
            ...
            William's House is an equal opportunity employer and values diversity in the workplace.
            `,
  },
  {
